...
const Webhooks = require('../../src/collection/resources/webhooks');
const Webhook = require('../../src/collection/objects/webhook');
...
const checkArchitectureMatchesJsonFile = (id, res, object) => {
  ...
  // admin should have access to user role as well.
  const objectFunctions = model.object.roles.admin.concat(model.object.roles.user);
...
describe.only('Architectural tests', () => {
  ...
  it('Should check architecture file correspong for Event', (done) => {
    checkArchitectureMatchesJsonFile('Event', new Events(), new Event());
    done();
  });
  ...
  it('Should check architecture file correspong for Webhook', (done) => {
    checkArchitectureMatchesJsonFile('Webhook', new Webhooks(), new Webhook());
    done();
  });
  it('Should match webhook resource and object', (done) => {
    checkMatchingModels(new Webhooks(), new Webhook());
    done();
  });
});
